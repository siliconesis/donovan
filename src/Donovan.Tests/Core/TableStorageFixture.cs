...
namespace Donovan.Tests.Core
{
    public class TableStorageFixture
    {
        ...
        public TableStorageFixture()
        {
            ...
            this.ConnectionString = this.Configuration["ConnectionStrings:TableStorage"];
        ...
        private void CreateClients()
        {
            ...
            // Create clients.
            var clients = new List<Donovan.Server.Security.Client>()
            {
                new Donovan.Server.Security.Client() { Id = "donovan_tests",          Name = "Donovan Tests",            Secret = PasswordHelper.HashPassword("QJIE3ZQeY1f10K146DA7IkpWy4bMXnUG"), IsEnabled = true },
                new Donovan.Server.Security.Client() { Id = "donovan_tests_disabled", Name = "Donovan Tests (Disabled)", Secret = PasswordHelper.HashPassword("ZUq6k7DG86Z6usIjMOZ0xY8hnTZGiAKg"), IsEnabled = false }
            };
